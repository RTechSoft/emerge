<section id="header" data-type="background" data-speed="10">
	...
	<div class="container-transparent text-center">
		...
		<h1>
			<img src="<?php echo Yii::app()->theme->baseUrl.'/library/img/logo/logo.png'; ?>" height="50" alt="emerge">
		</h1>
		<h1 class="page-title">Tulong! Tulong! Saklolo!</h1>
		<h4 class="page-sub-title">Kailangan ko ng tulong mo!</h4>
		<div class="showcase">
